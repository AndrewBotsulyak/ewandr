...
/**
 * Правильный способ добавления кастомной логики в Module Federation
 * Используем async функцию для правильной работы с withModuleFederation
 * DTS Plugin is disabled in Nx Workspaces as Nx already provides Typing support for Module Federation
 * The DTS Plugin can be enabled by setting dts: true
 * Learn more about the DTS Plugin here: https://module-federation.io/configure/dts.html
 */
export default async function (webpackConfigOptions: WebpackConfigOptions) {
  // Получаем базовую конфигурацию Module Federation
  ...
  // Объединяем с нашими кастомными настройками
